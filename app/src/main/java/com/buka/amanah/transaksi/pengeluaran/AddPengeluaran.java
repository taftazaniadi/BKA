...
public class AddPengeluaran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etPickTgl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(AddPengeluaran.this, date, myCalendar
    ...
    private void getBiayaList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        ArrayAdapter adapter = new ArrayAdapter<String>(AddPengeluaran.this, android.R.layout.simple_spinner_dropdown_item, bebas);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(AddPengeluaran.this, "error: " + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(AddPengeluaran.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        // Creates the adapter and set it to the AutoCompleteTextView
                        ArrayAdapter adapter = new ArrayAdapter<String>(AddPengeluaran.this, android.R.layout.simple_spinner_dropdown_item, bebas1);
    ...
    public void confirmation(View view) {
        MaterialDialog mDialog = new MaterialDialog.Builder(AddPengeluaran.this)
                .setTitle("Confirmation", TextAlignment.CENTER)
                .setMessage("Apa anda yakin untuk menambahkan Data Pengeluaran ini?")
...
//        } else {
        try {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(AddPengeluaran.this);
