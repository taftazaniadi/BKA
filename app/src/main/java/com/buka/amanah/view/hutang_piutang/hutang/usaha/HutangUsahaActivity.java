package com.buka.amanah.view.hutang_piutang.hutang.usaha;
...
public class HutangUsahaActivity extends AppCompatActivity {
    
    Button buttonHutangUsaha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hutang_usaha);
        ...
        actionbar.setTitle("Hutang Usaha");

        buttonHutangUsaha = findViewById(R.id.buttonHutangUsaha);
    ...
    private void initializeTableView() {
        ...
        TableViewAdapter tableViewAdapter = new TableViewAdapter(tableViewModel, HutangUsahaActivity.this);

        mTableView.setAdapter(tableViewAdapter);
        mTableView.setTableViewListener(new TableViewListener(mTableView, HutangUsahaActivity.this));

        // Create an instance of a Filter and pass the TableView.
        //mTableFilter = new Filter(mTableView);

        // Load the dummy data to the TableView
        tableViewAdapter.setAllItems(tableViewModel.getColumnHeaderList("Hutang Usaha"), tableViewModel
                .getSimpleRowHeaderList(), tableViewModel.getCellList("Hutang Usaha", message));
    ...
    private void initializeTableViewDetails() {
        ...
        mTableViewDetails.setTableViewListener(new TableViewListener(mTableViewDetails, HutangUsahaActivity.this));

        // Create an instance of a Filter and pass the TableView.
        //mTableFilter = new Filter(mTableView);

        // Load the dummy data to the TableView
        tableViewAdapter.setAllItems(tableViewModel.getDetailColumnHeaderList("Hutang Usaha"), tableViewModel
                .getDetailRowHeaderList("Hutang Usaha"), tableViewModel.getDetailCellList("Hutang Usaha", messageDetail));
    }
