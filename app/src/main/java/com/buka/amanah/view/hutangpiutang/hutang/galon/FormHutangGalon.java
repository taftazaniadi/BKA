package com.buka.amanah.view.hutangpiutang.hutang.galon;
...
public class FormHutangGalon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etTgl = findViewById(R.id.editTextTglHutangGalon);
        etPickTgl = (ImageButton) findViewById(R.id.buttonPickTglHutangGalon);
        ...
        etPickTgl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(FormHutangGalon.this, date, myCalendar
    ...
    private void getCustList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        ArrayAdapter adapter = new ArrayAdapter<String>(FormHutangGalon.this, android.R.layout.simple_spinner_dropdown_item, bebas);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(FormHutangGalon.this, "error: " + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FormHutangGalon.this);
        requestQueue.add(stringRequest);
    }

    public void addHutangGalon() {
        String url = getString(R.string.host_debt_gallon_add);
        ...
        try {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(FormHutangGalon.this);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (message.getStatus().equalsIgnoreCase("success")) {
                        MaterialDialog mDialog = new MaterialDialog.Builder(FormHutangGalon.this)
                                ...
                                .setPositiveButton("Selesai", new MaterialDialog.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int which) {
                                        ...
                                        Intent i = new Intent(getApplicationContext(), HutangGalonActivity.class);
                                        startActivity(i);
                                        finishAffinity();
                                    }
                                })
                                .setNegativeButton("Tambah Lagi", new MaterialDialog.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int which) {
                                        ...
                                        Intent i = new Intent(getApplicationContext(), FormHutangGalon.class);
    ...
    public void updateHutangGalon() {
        String url = getString(R.string.host_debt_gallon_update);
        final String idCust;
