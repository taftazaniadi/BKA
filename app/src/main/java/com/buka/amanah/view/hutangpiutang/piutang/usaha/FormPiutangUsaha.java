...
import com.buka.amanah.model.receipt_list.ReceiptList;
...
public class FormPiutangUsaha extends AppCompatActivity {
    ...
    AutoCompleteTextView actPelanggan, actPiutangUsaha;
    ImageButton etPickTgl;
    Button btnBatal, btnPiutangUsaha;
    int a, b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etTgl = findViewById(R.id.editTextTglPiutangUsaha);
        etPickTgl = (ImageButton) findViewById(R.id.buttonPickTglPiutangUsaha);
        etJumlah = findViewById(R.id.editTextJumlahPiutangUsaha);
        etHarga = findViewById(R.id.editTextHargaPiutangUsaha);
        ...
        actPiutangUsaha = (AutoCompleteTextView) findViewById(R.id.actTransaksiUsaha);
        btnBatal = findViewById(R.id.btn_cancel_piutang_usaha);
        btnPiutangUsaha = findViewById(R.id.btn_form_piutang_usaha);
        ...
        if (getIntent().getStringExtra("method").equalsIgnoreCase("Edit")) {
            actionbar.setTitle("Edit Piutang Usaha");

            getDetailPiutangUsaha(getIntent().getStringExtra("creditId"));

            btnPiutangUsaha.setOnClickListener(new View.OnClickListener() {
                @Override
        ...
        etPickTgl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(FormPiutangUsaha.this, date, myCalendar
        ...
        getReceiptList();
        actPiutangUsaha.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                actPiutangUsaha.showDropDown();
                InputMethodManager imm = (InputMethodManager) getApplicationContext().getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.hideSoftInputFromWindow(actPiutangUsaha.getWindowToken(), 0);
                return false;
            }
        });
        actPiutangUsaha.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                getReceiptList();
                actPiutangUsaha.showDropDown();
        ...
        actPiutangUsaha.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
...
//                getCustList();
        ...
        btnBatal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(), PiutangUsahaActivity.class));
                finish();
            }
        });
    }
    ...
    private void getReceiptList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        ArrayAdapter adapter = new ArrayAdapter<String>(FormPiutangUsaha.this, android.R.layout.simple_spinner_dropdown_item, bebas);
                        actPiutangUsaha.setAdapter(adapter);
                    }
                },
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(FormPiutangUsaha.this, "error: " + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(FormPiutangUsaha.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        // Creates the adapter and set it to the AutoCompleteTextView
                        ArrayAdapter adapter = new ArrayAdapter<String>(FormPiutangUsaha.this, android.R.layout.simple_spinner_dropdown_item, bebas1);
    ...
    private void getDetailPiutangUsaha(String id) {
        ...
        try {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(FormPiutangUsaha.this);
...
//                    }
    ...
    public void addPiutangUsaha() {
        String url = getString(R.string.host_credit_bussiness_add);

        try {
            JSONObject jsonBody = new JSONObject();
            jsonBody.put("date", etTgl.getText().toString() + " 00:00:00");
            jsonBody.put("customerId", Integer.parseInt(id_cust));
            jsonBody.put("price", Integer.parseInt(id_type));
            jsonBody.put("qty", Integer.parseInt(etJumlah.getText().toString()));
            jsonBody.put("total", Integer.parseInt(etHarga.getText().toString()));
            jsonBody.put("", Integer.parseInt(etTotal.getText().toString()));
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    if (message.getStatus().equalsIgnoreCase("success")) {
                        MaterialDialog mDialog = new MaterialDialog.Builder(FormPiutangUsaha.this)
                                ...
                                .setPositiveButton("Selesai", new MaterialDialog.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int which) {
                                        ...
                                        Intent i = new Intent(getApplicationContext(), PiutangUsahaActivity.class);
...
//                                        i.putExtra("total", etTotal.getText().toString());
                                ...
                                .setNegativeButton("Tambah Lagi", new MaterialDialog.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int which) {
                                        ...
                                        Intent i = new Intent(getApplicationContext(), FormPiutangUsaha.class);
                                        i.putExtra("method", "Add");
                                        startActivity(i);
                                        finishAffinity();
                                    }
    ...
    public void updatePiutangUsaha() {
