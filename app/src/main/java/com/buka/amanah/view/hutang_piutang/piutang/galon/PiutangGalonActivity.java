package com.buka.amanah.view.hutang_piutang.piutang.galon;
...
public class PiutangGalonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_piutang_galon);
        ...
        actionbar.setTitle("Piutang Galon");

        buttonPiutangGalon = findViewById(R.id.buttonPiutangGalon);

        buttonPiutangGalon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), FormPiutangGalon.class);
    ...
    private void initializeTableViewDetails() {
        ...
        // Load the dummy data to the TableView
        tableViewAdapter.setAllItems(tableViewModel.getDetailColumnHeaderList("Piutang Galon"), tableViewModel
                .getDetailRowHeaderList("Piutang Galon"), tableViewModel.getDetailCellList("Piutang Galon", messageDetail));
    }
